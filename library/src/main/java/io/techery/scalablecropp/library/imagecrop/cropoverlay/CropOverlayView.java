package io.techery.scalablecropp.library.imagecrop.cropoverlay;
...
import io.techery.scalablecropp.library.imagecrop.cropoverlay.utils.PaintUtil;
...
public class CropOverlayView extends View implements PhotoViewAttacher.IGetImageBounds {
    ...
    private int DEFAULT_RATIO_X = 3;
    private int DEFAULT_RATIO_Y = 1;
    ...
    public CropOverlayView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mRatioX = ta.getInteger(R.styleable.CropOverlayView_ratioX, DEFAULT_RATIO_X);
            mRatioY = ta.getInteger(R.styleable.CropOverlayView_ratioY, DEFAULT_RATIO_Y);
        } finally {
            ta.recycle();
        }
    ...
    private void init(Context context) {
        ...
        cropHeight = cropWidth * mRatioY / mRatioX;
